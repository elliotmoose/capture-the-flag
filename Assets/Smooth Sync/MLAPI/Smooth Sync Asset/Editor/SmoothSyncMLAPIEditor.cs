...
namespace Smooth
{
    [CustomEditor(typeof(SmoothSyncMLAPI))]
    public class SmoothSyncMLAPIEditor : Editor
    {
        ...
        {
            SmoothSyncMLAPI myTarget = (SmoothSyncMLAPI)target;
            ...
            if (showExtrapolation)
            {
                ...
                if (myTarget.extrapolationMode == SmoothSyncMLAPI.ExtrapolationMode.Limited)
                {
